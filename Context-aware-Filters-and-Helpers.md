...
| single post | /my-post | T | F | post.hbs | post-template, tag-* | _post-template, tag-*_ | [post] | {post}
| single page | /my-page | T | F | page-{{slug}}.hbs or page.hbs or post.hbs | post-template, page, tag-* | _page-template, tag-*_ | [post] | {post}
