...
* Advanced post features
    ...
    * Image uploads
    * Other potential features for this release include a simple RSS feed, search, comments (disqus), custom fields, haunted markdown (image, video, small). We'll play it by ear and see which features we think are most important.
